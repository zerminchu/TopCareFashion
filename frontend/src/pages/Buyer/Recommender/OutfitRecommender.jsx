...
const Home = () => {
  ...
  const handleGoClick = () => {
    ...
    if (inputData.length !== 0) {
      ...
      axios
        .post(
          "http://localhost:8000/api/text2image/",
          { text: inputData },
          {
            headers: {
  ...
  const handleResetContext = () => {
    axios
      .post(
        "http://localhost:8000/api/deletecontext/",
        { text: inputData },
        {
          headers: {
            Authorization: Cookies.get("jwt"),
  ...
  return (
    <div className="home">
      ...
      <div className="bottom-chat-box">
        ...
        />
        <button id="go-button" onClick={handleGoClick}>
          {" "}
          &gt;&gt;
        </button>
      </div>
      ...
      <div className="resetContext" onClick={handleResetContext}>
